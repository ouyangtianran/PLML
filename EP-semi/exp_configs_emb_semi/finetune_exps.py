...
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_test,resnet12_semi_norm]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20, 50, 100]:#[20, 60, 120, 300, 540]:
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['proto_finetune2'] += [new_setting]
...
EXP_GROUPS["proto_finetune_tiered2"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_tiered_imagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_test, resnet12_semi_norm]:#[ resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['proto_finetune_tiered2'] += [new_setting]
...
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_inv]:# [conv4semi_inv, resnet12_semi_inv] [, resnet12_semi_inv conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20]:#[20, 50, 100][20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                        # "ngpu": 1,
                        # "lr": 0.001,
                        # "pretrained_weights_root": "./logs_flexmatch/finetune_cw01",#"../TorchSSL/saved_models/",#"./logs_semi_base_norm/pretrain_tiered",
                        "pretrained_weights_root": "../TorchSSL/saved_models/",
                        # "embedding_prop": False,
                        # "distance_type": "prototypical",
    ...
    for backbone in [conv4semi_inv, resnet12_semi_inv]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    ...
                    new_dict={
                        ...
                        # "ngpu": 4,
                        # "lr": 0.001,
                        "pretrained_weights_root": "./logs_flexmatch/finetune_cw01_tiered",#"../TorchSSL/saved_models/",#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                        # "embedding_prop": False,
                        # "distance_type": "prototypical",
...
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4noise]:#[, resnet12_noise, conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        for npc in [20]:#, 50, 100]:#[20, 60, 120, 300, 540]:
            for cw in [0.1]:#[0, 0.1, 0.2, 0.5, 1, 2]:
            ...
            #     for query_drop_rate in [0.2, 0.3, 0.5, 0.0, 0.1]:#[0.2]
                # for oqw, te in [[True, True]]:#,[False, True],[True, False], [True, True] ]:
                    ...
                    new_dict={
                        ...
                        "logits_consistency_knn":5,
                        "resort": True,
                        "query_drop_rate": 0.0, #query_drop_rate,
                        "drop_type": "sort",
                        # "soft_label": True,
                        "embedding_prop": True,
                    }
...
EXP_GROUPS["finetune_noise_nd10"]=[]
base_setting = EXP_GROUPS['finetune'][0]
nd=10
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4noise]:#[, resnet12_noise, conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        for npc in [50, 100]:#, 50, 100]:#[20, 60, 120, 300, 540]:
            for cw in [0.1]:#[0, 0.1, 0.2, 0.5, 1, 2]:
                # for rbf_scale in [0, 0.01, 0.005, 0.05]:#[0.15, 0.3, 0.5]:#[0.1, 0.2, 0.05]:
                # for ep_knn in [0]:#[5, 10, 1, 0]:
            # for resort in [True, False]:
            #     for query_drop_rate in [0.2, 0.3, 0.5, 0.0, 0.1]:#[0.2]
                # for oqw, te in [[True, True]]:#,[False, True],[True, False], [True, True] ]:
                    ...
                    new_dict={
                        ...
                        "ngpu": 1,
                        # "lr": 0.001,
                        "pretrained_weights_root": "../semco/saved_models_nd_{}/".format(nd),#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_noise_nd10'] += [new_setting]

EXP_GROUPS["finetune_noise_npc20"]=[]
base_setting = EXP_GROUPS['finetune'][0]
nd=10
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4noise]:#[, resnet12_noise, conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        for npc in [20]:#, 50, 100]:#[20, 60, 120, 300, 540]:
            ...
            #     for query_drop_rate in [0.2, 0.3, 0.5, 0.0, 0.1]:#[0.2]
                # for oqw, te in [[True, True]]:#,[False, True],[True, False], [True, True] ]:
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_noise_npc20'] += [new_setting]

EXP_GROUPS["finetune_noise_all"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [resnet12_noise]:#conv4noise]:#[, resnet12_noise, conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        for npc in [-1]:#, 50, 100]:#[20, 60, 120, 300, 540]:
            for cw in [0.1]:#[0, 0.1, 0.2, 0.5, 1, 2]:
                # for rbf_scale in [0, 0.01, 0.005, 0.05]:#[0.15, 0.3, 0.5]:#[0.1, 0.2, 0.05]:
                # for ep_knn in [0]:#[5, 10, 1, 0]:
            # for resort in [True, False]:
            #     for query_drop_rate in [0.2, 0.3, 0.5, 0.0, 0.1]:#[0.2]
                # for oqw, te in [[True, True]]:#,[False, True],[True, False], [True, True] ]:
                    ...
                    new_dict={
                        ...
                        "ngpu": 1,
                        # "lr": 0.001,
                        "pretrained_weights_root": "./logs_semi_base_norm/pretraining3",#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_noise_all'] += [new_setting]

EXP_GROUPS["finetune_with_lp"]=[]# only use label propagation for finetuning
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4noise]:#[, resnet12_noise, conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        for npc in [20]:#, 50, 100]:#[20, 60, 120, 300, 540]:
            ...
            #     for query_drop_rate in [0.2, 0.3, 0.5, 0.0, 0.1]:#[0.2]
                # for oqw, te in [[True, True]]:#,[False, True],[True, False], [True, True] ]:
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_with_lp'] += [new_setting]
...
EXP_GROUPS["marginmatch_finetune"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_inv]:#[conv4semi_inv, resnet12_semi_inv] [, resnet12_semi_inv conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                        "ngpu": 1,
                        # "lr": 0.001,
                        "pretrained_weights_root": "../MarginMatch/saved_models/",#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                        # "embedding_prop": False,
                        # "distance_type": "prototypical",
                        ...
                        # semi dataset
                        "num_per_class": npc,
                        "pretrain_method": 'marginmatch',
                    }
                    new_setting.update(new_dict)
                    EXP_GROUPS['marginmatch_finetune'] += [new_setting]
                    
EXP_GROUPS["proto_finetune_marginmatch"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [resnet12_semi_inv]:#[conv4semi_test,resnet12_semi_norm]#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [100]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                        # "ngpu": 1,
                        # "lr": 0.001,
                        "pretrained_weights_root": "../MarginMatch/saved_models/", #../semco/saved_models/",#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                        # "embedding_prop": False,
                        "distance_type": "prototypical",
                        "trans_encoder":False,
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['proto_finetune_marginmatch'] += [new_setting]
                    
EXP_GROUPS["proto_finetune_flexmatch"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [semi_miniimagenet]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_inv]:#[conv4semi_test,resnet12_semi_norm]#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            for npc in [20]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                        # "ngpu": 1,
                        # "lr": 0.001,
                        "pretrained_weights_root": "../TorchSSL/saved_models/", #../semco/saved_models/",#"./logs_semi_base_norm/pretrain_tiered",
                        # "pretrained_weights_root": "./logs_test/pretraining",
                        # "embedding_prop": False,
                        "distance_type": "prototypical",
                        "trans_encoder":False,
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['proto_finetune_flexmatch'] += [new_setting]
