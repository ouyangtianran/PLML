...
semi_tiered_imagenet = {
    "dataset": "tiered-imagenet",
    "n_classes": 351,
    "dataset_train": "semi_tiered-imagenet",
...
trans = ""#"normalize"
un_mu = 0
un_mu_bs = [[0, 128]]#[[1,64],[3,32],[7,16]]
shot=5
query_shot=15
ul = "" #"semco",#["simsiam","word_proto","rotation","classifier_loss"]
...
for dataset in [semi_cub]:#[semi_miniimagenet,miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_test]:#[resnet12_semi_norm,wrn_semi_norm,conv4semi_test,conv4semi_test_basic, conv4semi_test,conv4, resnet12, wrn]:
        ...
        # for wew in [0.5, 10]:
        for npc in [20]:#[2, 6, 10]:#[20, 50, 100, 250,-1]:
