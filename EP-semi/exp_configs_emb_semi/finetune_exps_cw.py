...
use_unlabeled_data = "no_iteration"  # "no_iteration",#"iterating_optimization", #""
for dataset in [semi_miniimagenet]:#[miniimagenet, tiered_imagenet, cub]:
    for backbone in [resnet12_semi_norm]:#[conv4semi_test,wrn_semi_norm,resnet12_semi_norm,conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        ...
        # for p_thr_g in [-1, -2]:
        for use_unlabeled_data in ["no_iteration", "iterating_optimization"]:
            for un_mu, bs in un_mu_bs:
            # for p_thr in [ 0.1, 0.5, 0.7, 0.95]:
            # for p_thr_g in [0.1, 0.5, 0.7, 0.95, 0]:
        #     for shot in [1]:  # [1]:#
              for npc in [50]:#[20, 50, 100]:#[20, 50, 100, 250]:#[20]:#[20, 60, 120, 300, 540]:
                # for train_iters in [100]:  # [100, 600]:
                # for unlabeled_size_train in [4,8,12]:
                    for classification_weight in [0, 0.5, 1, 1.5]:#[0, 0.1, 0.5, 1, 1.5, 2, 3]:  # [0, 0.1, 0.5,1,1.5, 2, 3]:
                            EXP_GROUPS['finetune'] += [{"model": backbone,
                                                        ...
                                                        "test_iters": 1000,
                                                        "tasks_per_batch": 1,
                                                        "pretrained_weights_root": "../semco/saved_models/",
