        ...
        for npc in [20, 50, 100]:
            for shot in [1,5]:#[1, 5]:
                EXP_GROUPS['ssl_large'] += [{
                    ...
                    "finetuned_weights_root": "./logs_semi_base_semco_v3/finetune_cw01",
            ...
            for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                for shot in [1, 5]:  # [1, 5]:
                    ...
                    new_dict={
                        ...
                        # semi dataset
                        "num_per_class": npc,
                        "finetuned_weights_root": "./logs_semi_base_semco_v3/finetune_cw01_tiered",
                        "support_size_train": shot,
                        "support_size_val": shot,
                        "support_size_test": shot,
                    }
            ...
            for npc in [20, 50, 100]:#[20, 60, 120, 300, 540]:
                for shot in [1, 5]:
                    ...
                    new_dict={
                        ...
                        # semi dataset
                        "num_per_class": npc,
                        "finetuned_weights_root": "./logs_flexmatch/finetune_cw01",
                        "support_size_train": shot,
                        "support_size_val": shot,
                        "support_size_test": shot,
                    }
            ...
            for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                for shot in [1, 5]:
                    ...
                    new_dict={
                        ...
                        # semi dataset
                        "num_per_class": npc,
                        "finetuned_weights_root": "./logs_flexmatch/finetune_cw01_tiered",
                        "support_size_train": shot,
                        "support_size_val": shot,
                        "support_size_test": shot,
                    }
