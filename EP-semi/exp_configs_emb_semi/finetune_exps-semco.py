...
for dataset in [semi_miniimagenet]:#[miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4semi_test]:#[conv4semi_test,wrn_semi_norm,resnet12_semi_norm,conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
        ...
        #     for shot in [1]:  # [1]:#
              for npc in [20, 50, 100]:#[20, 50, 100]:#[20, 50, 100, 250]:#[20]:#[20, 60, 120, 300, 540]:
