...
def print_score(root, fold_name, compare_papameters, score_names):
    ...
    for pn in print_names:
        ...
        # else:
            ...
            if isinstance(out0, int):
                out0 = '{:04d}'.format(out0)
            print_str += '{}: {}, '.format(pn, out0)
            out_list.append(out0)
    ...
    for d in data:
        if 'train_test_accuracy' in d.keys():
            val_acc = d['train_test_accuracy']
        else:
...
d='/home/xd1/code/EP-semi/logs_semi_base_semco_v3/finetune_cw01'
d='/home/xd1/code/EP-semi/logs_semi_base_semco_v3/finetune_cw01_tiered'
d='/home/xd1/code/EP-semi/logs_semi_base_semco_v3/finetune_cw01_cub_lr0001_1gpu'
d='/home/xd1/code/EP-semi/logs_semi_base_semco_v3/finetune_cw01_tiered_lr0001'
# d='./logs_semi_base_semco_proto/finetune_cw01'
# d='logs_semi_base_semco_proto/finetune_cub_cw01'
# d='logs_semi_base_semco_proto/finetune_tiered_cw01'

# d='/home/xd1/code/EP-semi/logs_flexmatch/finetune_cw01'
# d='/home/xd1/code/EP-semi/logs_flexmatch/proto_cw01'
...
score_names = ['train_test_accuracy']
ll = os.listdir(d)
outs = []
print(d)
for l in ll:
