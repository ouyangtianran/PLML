...
def parse_args():
    ...
    # Model configuration
    parser.add_argument('--dataset-path', type=str, default=os.environ.get('SEMCO_DATA_PATH', './datasets'),
    ...
    parser.add_argument('--word-vec-path', type=str,
                        default=os.environ.get('SEMCO_WV_PATH',
                                               './datasets/numberbatch-en-19.08_128D.dict.pkl'),
    ...
    parser.add_argument('--n-imgs-per-epoch', type=int, default=64 * 1024, #1024
