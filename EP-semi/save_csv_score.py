...
d = './logs_flexmatch/finetune_cw01'
...
d='./logs_noise_semco_v10/finetune_no_trans_encoder'
d='./logs_noise_semco_v10/finetune_trans_encoder_knn'
d='logs_noise_semco_v12/finetune_trans_encoder_resort3'
# d='./logs_tmp/test2'
# d='./logs_tmp/backup'
...
# compare_papameters =[ "rbf_scale","num_per_class"]
# compare_papameters =[ "only_query_weight","trans_encoder"]
# compare_papameters = ["ep_knn","num_per_class" ]
compare_papameters = ["resort", "query_drop_rate"]

score_names = ['train_test_accuracy','test_accuracy','val_accuracy']#,'used_data_ratio','accuracy_used_data','val_accuracy'
# score_names = ['test_accuracy']
ll = os.listdir(d)
outs = []
print(d)
for l in ll:
